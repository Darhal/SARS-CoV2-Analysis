...
def test_quartile():
    ...
    assert quartile(2, [9, 8, 7, 6, 5, 4, 3, 2, 1, 0]) == 7
    assert quartile(2, [9, 8, 7, 6, 5, 4, 3, 2, 1, 0, 10]) == mediane([9, 8, 7, 6, 5, 4, 3, 2, 1, 0])
    assert quartile(1, [9, 8, 7, 6, 5, 4, 3, 2, 1, 0, 10]) == 3
    assert quartile(3, [9, 8, 7, 6, 5, 4, 3, 2, 1, 0, 10]) == 8
    assert quartile(2, [9, 8, 7, 6, 5, 4, 3, 2, 1, 0, 10, 11]) == mediane([9, 8, 7, 6, 5, 4, 3, 2, 1, 0, 10, 11])
    assert quartile(1, [9, 8, 7, 6, 5, 4, 3, 2, 1, 0, 10, 11]) == 3.5
