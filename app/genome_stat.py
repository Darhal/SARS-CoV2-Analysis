...
print(f"Mediane: {stats_taille['med']}")
print(f"ecart type: {stats_taille['ecartt']}")
print(f"Variance: {stats_taille['var']}")
print(f"Quart 1: {stats_taille['quart1']}")
print(f"Quart 3: {stats_taille['quart3']}")
print(f"Inter Quart 3: {stats_taille['int_quart']}")
...
print(f"Mediane: {stats_nucleo['med']}")
print(f"ecart type: {stats_nucleo['ecartt']}")
print(f"Variance: {stats_nucleo['var']}")
print(f"Quart 1: {stats_nucleo['quart1']}")
print(f"Quart 3: {stats_nucleo['quart3']}")
print(f"Inter Quart 3: {stats_nucleo['int_quart']}")
