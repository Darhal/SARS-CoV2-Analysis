...
# ###################### LEVENSHTEIN ######################
# lev_args = arg_generator(N=200, stride=20, type=STRINGS, samples=NUCLEOTIDES, variant_arg_pos=[0, 1])
# funcs_performance([ lev_rec, lev_dp, lev ], args_arr=lev_args, sizes=[0], tick_spacing=2)

###################### NEEDLEMAN ######################
nw_args = arg_generator(N=900, stride=10, type=STRINGS, samples=NUCLEOTIDES, variant_arg_pos=[0, 1], static_args=[[1, -1, -1]], start=1)
...
nw_args = arg_generator(N=1000, stride=10, type=STRINGS, samples=NUCLEOTIDES, variant_arg_pos=[0, 1], start=1,
