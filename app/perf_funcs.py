...
if __name__ == '__main__':
    ...
    nw_args = arg_generator(N=10, stride=1, type=STRINGS, samples=NUCLEOTIDES, variant_arg_pos=[0, 1], static_args=[[0, 0, 0]], start=1)
    ...
    nw_args = arg_generator(N=150, stride=10, type=STRINGS, samples=NUCLEOTIDES, variant_arg_pos=[0, 1], start=1,
