...
\textbf{Nom, prénom :} TOUNSI OMEZZINE, Chaima 

\textbf{Élève ingénieur inscrit en 1ère année à TELECOM Nancy} 

\textbf{Numéro de carte étudiante :} 32025001 

\textbf{Année universitaire :} 2020 - 2021 

\textbf{Auteur, en collaboration avec CHIDA Mohamed Omar, DUMAS Mathis et ZHANG Céline, du rapport : } 
...
\begin{figure}[!h]
    \begin{flushright}
        \includegraphics[scale=0.5]{Images/Intro/Signatures/Chaima.png}
    \end{flushright}
\end{figure}